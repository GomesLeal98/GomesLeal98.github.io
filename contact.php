...
<head>
    <meta charset="utf-8" />
    <title>José Gomes dos Santos Leal Neto</title>

    <!-- Meta Data -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <meta name="author" content="José Gomes dos Santos Leal Neto" />
    <meta name="description"
        content="Portifólio de trabalhos realizados e formação de José Gomes dos Santos Leal Neto" />
    <!-- Styles -->
        ...
        <div class="container gutter-top">
                ...
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/profile.jpeg"
                            alt="José Gomes dos Santos Leal Neto">
                    </div>
                    <div class="header__base-info">
                        <h4 class="title titl--h4">José Gomes dos Santos Leal Neto</h4>
                        <div class="status">Estudante de Desenvolvimento WEB</div>
                        <ul class="header__social">
                            <li>
                                <a href="https://github.com/GomesLeal98">
                                    <i class="font-icon icon-github"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.youtube.com/channel/UCGmen_Wq-WxUyJ7a3ofAH1g?view_as=subscriber">
                ...
                <div class="header__right">
                    <ul class="header__contact">
                        <li>
                            ...
                            gomesleal2014@gmail.com
                        </li>
                        <li>
                            <span class="overhead">Telefone</span><a
                                href="https://api.whatsapp.com/send?phone=55xxxxxxxxxxx">+55 (82) 9xxxx-xxxx </a>
                        </li>
                    </ul>
                    <ul class="header__contact">
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                    ...
                    <!-- Footer -->
                    <footer class="footer">© José Gomes dos Santos Leal Neto</footer>
                </div>
            </div>
        </div>
    </main>
